...
- "atestados": e uma lista de itens com "objeto", "quantidade" e "cat" (numero do CAT, quando houver). Para cada exigencia de atestado de capacidade tecnica, procure um atestado cujo objeto seja compativel e cuja quantidade atenda o que o EDITAL pede (compare a quantidade do atestado com o que o edital exige, nunca com o quantitativo total do objeto licitado, que e outra coisa). So marque "atende" se a quantidade do atestado cumprir literalmente o que o edital pede; se for menor, marque "nao_atende" ou "confirmar" (no rigor de sempre, na duvida use "confirmar"). NAO reduza a exigencia do edital pela metade por conta propria. Se, e so se, a propria exigencia do edital parecer pedir mais de 50% do quantitativo TOTAL do objeto licitado (o que pode violar a Sumula 263 do TCU, que limita esse teto), mencione isso na "observacao" do item como um possivel ponto impugnavel, mas mantenha o veredito baseado no que o edital literalmente pede, sem presumir a exigencia invalida.
