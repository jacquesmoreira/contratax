---
title: Atestado de capacidade técnica: o que é e como conseguir
description: O que é o atestado de capacidade técnica exigido em licitação, quem emite, o que deve constar e como consegui-lo mesmo sendo empresa nova.
date: 2026-05-16
keywords: atestado de capacidade técnica, atestado licitação, como conseguir atestado técnico, qualificação técnica licitação
---
...
As [dispensas de baixo valor](/blog/dispensa-de-licitacao) raramente exigem atestado. É a porta de entrada mais fácil pra construir histórico.
...
1. **Escreva você mesmo** um modelo de atestado com todos os campos preenchidos.
...
1. **Atestado genérico demais**: sem quantidade e valor, o órgão pode não aceitar.
2. **Atestado de serviço sem nenhuma relação**: tem que ser compatível com o objeto.
3. **Não guardar atestados antigos**: cada contrato cumprido é um ativo. Arquive todos.
4. **Aceitar exigência abusiva sem impugnar**: edital pedindo 100% do quantitativo é ilegal.
