---
title: Empate ficto: como ME e EPP ganham licitação com 5% a mais
description: O que é o empate ficto em licitação, como funciona o direito de preferência de ME e EPP, os percentuais de 5% e 10% e como usar isso para ganhar.
date: 2026-05-06
...
A lógica: o legislador quis dar uma vantagem competitiva a pequenas empresas, sem simplesmente entregar o contrato. Então criou esse "desempate" a favor delas.

## Os percentuais: 10% e 5%

A diferença depende da modalidade:

- **Regra geral (concorrência)**: ME/EPP empatada se estiver até **10% acima** da melhor proposta.
- **Pregão**: o percentual cai pra **5%**.

Como a maioria das licitações é pregão, o número que mais importa na prática é **5%**.

## Como funciona, na prática

Imagine um pregão eletrônico:
...
7. Só se nenhuma ME/EPP cobrir é que a empresa grande mantém a vitória.

## Quem tem direito

- **Microempresa (ME)**: faturamento até R$ 360 mil/ano
- **Empresa de Pequeno Porte (EPP)**: até R$ 4,8 milhões/ano
- **MEI**: equiparado a ME, tem o mesmo direito

Você precisa estar **enquadrado** e **declarar** essa condição na licitação. Sem a declaração, perde o benefício. Veja mais no guia de [ME e EPP em licitação](/blog/me-epp-em-licitacao).
...
Aqui está o ponto que poucos exploram: o empate ficto te dá uma **margem de manobra** na disputa.

Sabendo que você tem direito a cobrir um lance que esteja até 5% acima, você pode:
...
## Como saber quando o empate ficto está em jogo

Pra aproveitar, você precisa identificar rápido os editais onde você tem o benefício (item com participação de empresas grandes, valor que comporta ME/EPP) e estar preparado na sessão. Plataformas como o [ContrataX](https://www.contratax.com.br) destacam os editais com cota ou exclusividade pra ME/EPP e organizam suas oportunidades por valor, ajudando você a focar onde o seu porte vira vantagem.

## Resumo

O empate ficto considera empatadas as propostas de ME/EPP que ficam até 5% acima (no pregão) da melhor proposta de empresa grande, dando ao pequeno o direito de cobrir o lance e ganhar. É uma vantagem competitiva poderosa, mas exige declarar a condição de ME/EPP, estar online na sessão e ter o preço mínimo calculado de antemão. Usado com estratégia, permite ganhar com margem maior do que numa disputa aberta de preço.
