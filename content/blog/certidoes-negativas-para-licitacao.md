---
title: Certidões negativas para licitação: lista e onde emitir cada uma
description: Lista completa das certidões negativas exigidas em licitação, onde emitir cada uma online, prazo de validade e como não perder o prazo no dia do pregão.
date: 2026-05-12
...
### 1. Certidão Negativa de Débitos Federais (Conjunta)
- **Cobre**: tributos federais (Receita Federal) + dívida ativa da União (PGFN)
- **Onde emitir**: [regularize.pgfn.gov.br](https://www.regularize.pgfn.gov.br/) ou pelo e-CAC
- **Validade**: 180 dias
- **Custo**: gratuito
...
- **Cobre**: dívidas trabalhistas na Justiça do Trabalho
- **Onde emitir**: [cndt-certidao.tst.jus.br](https://cndt-certidao.tst.jus.br/)
- **Validade**: 180 dias
- **Custo**: gratuito

### 4. Certidão Negativa Estadual
- **Cobre**: ICMS e tributos estaduais
- **Onde emitir**: site da Secretaria da Fazenda (Sefaz) do seu estado
- **Validade**: varia (geralmente 30 a 60 dias)
- **Custo**: gratuito na maioria dos estados

### 5. Certidão Negativa Municipal
- **Cobre**: ISS e tributos municipais
- **Onde emitir**: site da Prefeitura da sua cidade
- **Validade**: varia (geralmente 30 a 90 dias)
- **Custo**: geralmente gratuito

### 6. Certidão Negativa de Falência e Recuperação Judicial
- **Cobre**: situação de falência ou recuperação
- **Onde emitir**: site do Tribunal de Justiça (TJ) do seu estado
- **Validade**: geralmente 30 a 90 dias (alguns editais especificam)
- **Custo**: pode ter pequena taxa, dependendo do estado

## Tabela rápida de validade

| Certidão | Validade típica | Renova com frequência |
|---|---|---|
| FGTS (CRF) | 30 dias | Mensal |
| Estadual | 30-60 dias | Mensal/bimestral |
| Municipal | 30-90 dias | Mensal/trimestral |
| Federal Conjunta | 180 dias | Semestral |
| Trabalhista (CNDT) | 180 dias | Semestral |
| Falência | 30-90 dias | Conforme edital |

> A do **FGTS é a vilã**: vence em 30 dias. É a que mais pega gente desprevenida.
...
Crie uma planilha com cada certidão e a data de vencimento. Configure um lembrete no celular 7 dias antes de cada uma. Funciona, mas exige disciplina.

### Opção 2: Renovar tudo antes de cada pregão importante
...
1. **Confiar na memória**: cada certidão vence num dia, é impossível lembrar de todas.
2. **Esquecer a do FGTS**: vence em 30 dias, a mais traiçoeira.
3. **Emitir só na hora do pregão**: se algum site estiver fora do ar, você não consegue.
4. **Não atualizar no SICAF**: ter a certidão em mãos não basta se o [SICAF](/blog/sicaf-o-que-e-como-cadastrar) está com a versão vencida.
