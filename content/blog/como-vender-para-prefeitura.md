---
title: Como vender para prefeitura: o guia para começar do zero
description: Passo a passo prático para vender produtos e serviços para prefeituras. Cadastro, onde achar as compras, documentos e como receber o pagamento.
date: 2026-05-20
...
Todas as licitações e dispensas de prefeitura são publicadas no **PNCP** ([pncp.gov.br](https://www.pncp.gov.br)), a base oficial. Você pode buscar lá manualmente por cidade e por produto, ou usar uma ferramenta que monitora isso pra você.
...
Entenda melhor no nosso guia de [dispensa de licitação](/blog/dispensa-de-licitacao).
