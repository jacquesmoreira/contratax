---
title: Como cobrar correção monetária e juros de prefeitura que atrasa pagamento
description: Passo a passo para cobrar correção monetária pelo IPCA e juros moratórios de 0,5% ao mês quando o órgão público atrasa o pagamento. Inclui fundamentação da Lei 14.133/2021 e modelo de ofício formal.
date: 2026-06-06
keywords: cobrar prefeitura atrasada, correção monetária contrato público, juros moratórios licitação, prefeitura não pagou, art 141 lei 14133, ofício de cobrança órgão público
---
...
```
Valor atualizado = Valor original × (1 + IPCA acumulado no período)
                  + (Valor atualizado × 0,5% × número de meses de atraso)
```
...
| Item | Valor |
|---|---|
| Valor original | R$ 5.432,10 |
| Correção monetária (IPCA estimado ~0,33% no período) | + R$ 17,93 |
| Juros moratórios (0,5% × 22/30 mês) | + R$ 19,93 |
| **Total devido** | **R$ 5.469,96** |

O ContrataX calcula esse valor pra você automaticamente em [/recebiveis](/recebiveis) e gera o ofício de cobrança formal pronto pra protocolar.
...
| Passo | O que fazer |
|---|---|
| 1 | Cadastre a NF emitida em [/recebiveis](/recebiveis) |
| 2 | O sistema te avisa quando passar de 30 dias |
| 3 | Gere o ofício formal com correção e juros já calculados |
| 4 | Protocole no órgão (presencial, SEI ou e-mail formal) |
| 5 | Se não pagar em 15 dias úteis, escalone pra advogado parceiro |
...
**Quer cadastrar suas NFs emitidas pra órgãos públicos e nunca mais esquecer de cobrar?** Crie sua conta em [/cadastro](/cadastro) e use o módulo Recebíveis no seu primeiro contrato vencido.
